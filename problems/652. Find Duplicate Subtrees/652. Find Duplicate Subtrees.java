 ...
 * thihhs.left = left; this.right = right; } }
 */
class Solution {
	...
	public int traverse(List<TreeNode> res, HashMap<Integer, Integer> cnt, HashMap<String, Integer> Triplet,
			TreeNode root) {
		if (root == null) {
			return 0;
		}
		String s_Triplet = traverse(res, cnt, Triplet, root.left) + "," + root.val + ","
				+ traverse(res, cnt, Triplet, root.right);
